...
@media only screen and (max-width: 600px) {
  ...
  <style>
    ...
    * {
    ...
    /* Primary Styles */
    body {font: 12px/1.231 Arial, Helvetica, sans-serif; background-color: #F2F2F2;}
            ...
            <tr>
              <td>
                <table class="row mail">
                  ...
                  $json1 = file_get_contents("http://api-internal.usatoday.com/PresentationService/v3/sites/PWES/fronts/newsletter_rockland/layouts?apiKey=newsletterrockland");
                  ...
                  $searchv4 = "http://api.gannett-cdn.com/prod/Search/v4/assets/proxy?fq=statusname:published&fq=sitecode:PWES&sc=PWES&apiKey=search-recipe&debug=true&format=json&fq=assettypename:text&fq=assetid:(".$assets_comma_string.")&sort=initialpublished%20desc&format=json&api_key=sshzqnyv3sexjez495684agd";
                  ...
                  for($s = 0; $s < count($stories); $s++){
                    ...
                    <td class='wrapper'>
                      <table class='eight columns'>
                        <tr>
                            <h4 style='font-size:1.4em;'><a href='".$stories[$s]['urls']['mobileUrl']."?utm_source=newsletter&utm_medium=email&utm_campaign=rockland_angle'>".$stories[$s]['headline']."</a></h4>
                            <p><i style='font-size:.8em;'>Author: ".$stories[$s]['attribution']['author']." | ".$stories[$s]['attribution']['publication']."</i></p>
                            <p style='font-size:1.2em;'>".$stories[$s]['promoBrief']."</p>
                            <p><a href='".$stories[$s]['urls']['mobileUrl']."?utm_source=newsletter&utm_medium=email&utm_campaign=rockland_angle'>Read more here</a></p>
                        </tr>
                      </table>
                    </td>
                  ";
