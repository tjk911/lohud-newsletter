            ...
            <tr>
              <td>
                <table class="row">
                  ...
                  $searchv4 = "http://api.gannett-cdn.com/prod/Search/v4/assets/proxy?fq=statusname:published&fq=sitecode:PWES&sc=PWES&apiKey=search-recipe&debug=true&format=json&fq=assettypename:text&fq=assetid:(".$assets_comma_string.")&sort=initialpublished%20desc&format=json&api_key=".$api2;
                  print_r($searchv4);
