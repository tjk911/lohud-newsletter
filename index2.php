...
<script type="text/javascript">
    ...
    function reqListener(e) {
        ...
        var feed = "http://api.gannett-cdn.com/prod/Search/v4/assets/proxy?fq=statusname:published&fq=sitecode:PWES&sc=PWES&apiKey=search-recipe&debug=true&format=json&fq=assettypename:text&fq={!terms f=assetid}"+assets+"&sort=initialpublished%20desc&format=json&api_key=sshzqnyv3sexjez495684agd";
